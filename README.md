...
Backend / Full-Stack Engineer with 5+ years of experience building production-ready systems used in real business operations.

I specialize in backend architecture, API design, and building scalable systems that solve real-world problems in retail and e-commerce.

---

## 📊 Impact
- Built and deployed multiple business systems (e-commerce, POS, inventory)
- Developed applications currently used for daily retail operations
- Designed backend architectures handling real data, transactions, and reporting
- Delivered solutions for real business environments, not just prototypes

---

## 🚀 What I Do
- Build scalable backend systems using Node.js and TypeScript
- Design REST APIs and database architectures
- Develop full-stack applications with real business impact
- Solve complex business problems through software systems
